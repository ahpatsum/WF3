...
<ul>
    ...
    <li><a href="contact.php"><i class="fa-solid fa-id-card"></i><span>Contact Information</span></a></li>
    ...
    <li><a href="loisir.php" class="selected"><i class="fa-solid fa-icons"></i><span>Interests and Hobbies</span></a></li>
...
<div class="right">
    ...
    <div class="content">
        <div class="container">
            ...
            <form action="includes/update/addloisir.php" class="mainform" method="post" enctype="multipart/form-data">
                <p>
                    <label>Interests and Hobbies</label>
                    <input type="text" name="titre" required>
                </p>
                <p>
                    <label>Icon <span class="txtIndication">(36px x 36px)</span></label>
                </p>
                <p>
                <div class="upload-btn-wrapper1">
                    <button class="btn1">Click to import an icon (png, jpg, ico)</button>
                    <input type="file" name="iconloisir" />
                </div>
                </p>
                <p>
                    <button type="login">Add</button>
                </p>
            </form>
            <div class="skills">
                <?php
                ...
                ?>
                <div class="skillitem">
                    <img src="img/loisirs/<?php echo $hobbies['icon']; ?>">
                    <div class="contenu">
                        <h4 class="oneliner"><?php echo ($hobbies['titre']); ?></h4>
                    </div>
                    <div class="editsup">
                        <form action="includes/update/deleteloisir.php" class="styledelete" name="form2" method="post">
                            <input type="hidden" name="id_loisir" value="<?php echo $hobbies['id_loisir']; ?>">
                            <!--<button type="submit" class="edit"><i class="fa-solid fa-file-pen"></i></button>-->
