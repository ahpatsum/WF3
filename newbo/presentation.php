...
?>
<ul>
    <li><a href="presentation.php" class="selected"><i class="fa-solid fa-user-gear"></i><span>Personal Information</span></a></li>
        ...
        <div class="container">
            ...
            <form action="includes/update/updatepresentation.php" class="mainform" method="post" enctype="multipart/form-data">
                ...
                <p>
                    ...
                    <textarea name="descr" id="" cols="30" rows="4"><?php echo($presentation_elements['descr']); ?></textarea>
                </p>
                <p>
