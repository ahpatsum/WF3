...
<ul>
    ...
    <li><a href="compperso.php" class="selected"><i class="fa-solid fa-id-card-clip"></i><span>Personal Skills</span></a></li>
...
<div class="right">
    ...
    <div class="content">
        <div class="container">
            ...
            <form action="includes/update/addcompperso.php" class="mainform" method="post">
                <p>
                    <label>Skill</label>
                    <input type="text" name="compperso" required>
                </p>
            ...
            <div class="skills">
                ...
                <div class="skillitem">
                    <div class="contenu">
                        <h4><?php echo ($personalskills['titre']); ?></h4>
                    </div>
                    <div class="editsup">
                        <form action="includes/update/deletecompperso.php" class="styledelete" name="form2"
                            method="post">
                            <input type="hidden" name="id_competenceperso"
                                value="<?php echo $personalskills['id_competenceperso']; ?>">
