...
<ul>
    ...
    <li><a href="formation.php" class="selected"><i class="fa-solid fa-graduation-cap"></i><span>Education</span></a>
    </li>
</ul>
<ul class="desconnect">
...
<div class="right">
    ...
    <div class="content">
        <div class="container">
            <h3>Formations</h3>
            <form action="includes/update/addformation.php" class="mainform" method="post">
                <p>
                ...
                <p>
                    <span class="dateexp">
                        ...
                        <input id="datepicker" name="datedebut" required>
                    </span>
                    <span class="dateexp" style="float: right;">
                        <label>End Year</label>
                        <input id="datepicker2" name="datefin" required>
                    </span>
                </p>
                <p>
            ...
            <div class="experiences">
                ...
                <div class="experience_item">
                    ...
                    <div class="editsup">
                        <form action="includes/update/deleteformation.php" class="styledelete" name="form2" method="post">
                    ...
                    <div class="date_formation">
                        <?php echo $formation['place']; ?> - <?php echo $formation['date_debut']; ?> -
