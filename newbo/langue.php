...
<ul>
    ...
    <li><a href="langue.php" class="selected"><i class="fa-solid fa-language"></i><span>Languages</span></a></li>
...
<div class="right">
    ...
    <div class="content">
        <div class="container">
            <h3>Languages</h3>
            <form action="includes/update/addlangue.php" class="mainform" method="post" name="form1">
                <p>
            ...
            <div class="skills">
                ...
                <div class="skillitem">
                    <div class="contenu">
                        <h4><?php echo ($language['titre']); ?></h4>
                    </div>
                    <div class="editsup">
                        <form action="includes/update/deletelangue.php" class="styledelete" name="form2" method="post">
                            <input type="hidden" name="id_langue" value="<?php echo $language['id_langue']; ?>">
