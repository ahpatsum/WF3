...
<ul>
    ...
    <li><a href="comppro.php" class="selected"><i class="fa-solid fa-suitcase"></i><span>Professional Skills</span></a></li>
            ...
            <div class="skills">
                ...
                <div class="skillitem">
                    ...
                    <div class="contenu">
                        ...
                        <p>Mastery level : <span class=""><?php echo $professionalskills['niveau']; ?></span></p>
                    </div>
                    <div class="editsup">
